UnicornStudio.addScene({
    ...
    filePath: "./unicorn-nometa-new.json", // if youre hosting your own exported json code, point to it here (do not use both filePath and projectId, only one is required)
